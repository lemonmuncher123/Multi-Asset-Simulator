...
class TestDeleteAllReports:
    ...
    @patch("src.gui.pages.import_export.QMessageBox.information")
    @patch("src.gui.pages.import_export.get_report_stats", return_value={"total": 0, "monthly": 0, "quarterly": 0, "semi_annual": 0, "annual": 0})
    ...
    @patch("src.gui.pages.import_export.get_report_stats", return_value={"total": 5, "monthly": 4, "quarterly": 0, "semi_annual": 0, "annual": 1})
