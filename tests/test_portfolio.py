...
def test_debt_liabilities(db_conn):
    ledger.add_debt(db_conn, "2025-01-01", symbol="SL", name="Student Loan", amount=50000.0)
    ledger.add_debt(db_conn, "2025-01-01", symbol="CC", name="Credit Card", amount=5000.0, cash_received=False)
...
def test_total_liabilities_combined(db_conn):
    ...
    ledger.add_debt(db_conn, "2025-01-01", symbol="CC", name="Card", amount=5000.0, cash_received=False)
...
def test_net_worth_full_scenario(db_conn):
    ...
    ledger.add_debt(db_conn, "2025-01-01", symbol="CC", name="Card", amount=3000.0, cash_received=False)
